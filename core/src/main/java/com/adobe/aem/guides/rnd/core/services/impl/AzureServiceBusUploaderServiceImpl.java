package com.adobe.aem.guides.rnd.core.services.impl;

import com.adobe.aem.guides.rnd.core.services.AzureServiceBusUploaderService;
import com.adobe.aem.guides.rnd.core.services.config.AzureServiceBusUploaderServiceConfig;
...
public class AzureServiceBusUploaderServiceImpl implements AzureServiceBusUploaderService {
    ...
    /* String id;    String connectionString;
     String queueName;    boolean uploadEnabled;*/

    @Activate
    protected void activate(final AzureServiceBusUploaderServiceConfig config) {
        this.config = config;
        log.info("Azure Service Bus Uploader Service is activated."
