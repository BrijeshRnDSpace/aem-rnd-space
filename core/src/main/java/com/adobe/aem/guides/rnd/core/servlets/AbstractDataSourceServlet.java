...
public abstract class AbstractDataSourceServlet<T> extends SlingSafeMethodsServlet {
    private static final String DATASOURCE_TEXT = "text";
    private static final String DATASOURCE_VALUE = "value";

    @Override
    protected abstract void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response) throws ServletException, IOException;
    ...
    protected Resource createDataSourceElement(ResourceResolver resolver, String key, String value) {
